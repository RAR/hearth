...
import com.rar.echodash.sendspin.sendspin.audio.AudioSink
import com.rar.echodash.sendspin.sendspin.audio.AudioTrackSink
...
class SyncAudioPlayer(
    ...
    private val latencyEstimator = com.rar.echodash.sendspin.sendspin.latency.OutputLatencyEstimator(
        nowNs = nowNs,
    )
    ...
    fun initialize() {
        ...
        try {
            ...
            latencyEstimator.start { result ->
                when (result) {
                    is com.rar.echodash.sendspin.sendspin.latency.OutputLatencyEstimator.Result.Converged -> {
                    ...
                    is com.rar.echodash.sendspin.sendspin.latency.OutputLatencyEstimator.Result.TimedOut -> {
                        timeFilter.setAutoMeasuredDelayMicros(
                            0L,
                            com.rar.echodash.sendspin.sendspin.latency.StaticDelaySource.NONE,
                        )
    ...
    private fun handleStartGatingDacAware(track: AudioSink): Boolean {
        ...
        if (latencyEstimator.status == com.rar.echodash.sendspin.sendspin.latency.OutputLatencyEstimator.Status.Measuring) {
